...
export default function PatientDetailPage() {
  ...
  useCopilotReadable({
    description: `Complete profile for subject ${currentPatient?.subjectId || patientId}`,
      ...
      <div className="mt-8 bg-gray-50 rounded-lg p-6 border border-gray-200">
        ...
        <div className="bg-white rounded-lg border border-gray-300 p-4">
          <p className="text-sm text-gray-600 mb-2">
            <strong>Available Context:</strong> Complete subject profile including visit history, vitals, and adverse events
          </p>
          <p className="text-sm text-gray-600 mb-2">
          ...
          <p className="text-sm text-gray-600">
            <strong>AI Capabilities:</strong> Subject data analysis, risk assessment, compliance monitoring, and treatment recommendations
          </p>
        </div>
      </div>
    </div>
